...
const source = `
# DSF-GEOS: SCANNER DSF ## DEEP SUBSURFACE STRUCTURE SURVEY SCANNER "DSF" ![image](/equipment/scanner/1.webp) ## TECHNICAL SPECIFICATIONS | Parameter | Designation | |-----------|-------------| | **1 Hardware parameters** | | | 1.1 Frequency range | from 1 to 100kHz | | 1.2 The sensitivity given to the antenna input of the complex | is not more than 1*10<sup>-6</sup> A/m | | 1.3 The time of continuous recording into the internal memory of the complex at a measurement frequency of 10 Hz | 12h | | 1.4 Continuous operation time from a fully charged battery | 20h | | **2 Degree of protection of enclosures:** | IP65 | | **3 Temperature range:** | |
